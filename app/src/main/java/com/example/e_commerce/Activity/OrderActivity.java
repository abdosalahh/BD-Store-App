                ...
                btn_send_feedback.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        for(int i = 0 ; i < cart_products.size(); i++){
                            Product p = db.get_products_by_id(cart_products.get(i).getProduct_id());
                            if(p.getQuantity() < cart_products.get(i).getQuantity()){
                                flag = false;
                            }
                        }
                        if(!flag){
                            Toast.makeText(getApplicationContext(), "Quantity in stock is not enough", Toast.LENGTH_SHORT).show();
                        }
                        else {
                            ...
                            if(!txt_feedback.getText().toString().isEmpty() && rate!=-1 && !address.isEmpty()){
                                ...
                                Toast.makeText(getApplicationContext(), "Please Enter Feedback and Rateing", Toast.LENGTH_SHORT).show();
                            }
                        }
